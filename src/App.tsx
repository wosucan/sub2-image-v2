...
import { setPresetConfig, getPresetProfileIds, getDefaultPresetProfileId, isPresetConfigOnlyEnabled } from './lib/presetConfig'
...
export default function App() {
  ...
  useEffect(() => {
    ...
    document.documentElement.classList.toggle('sub2api-embedded-gallery', isSub2ApiEmbeddedMode(searchParams))

    void initStore()
      .then(async () => {
        if (isSub2ApiEmbeddedMode(searchParams)) setAppMode('gallery')
