...
export type BuiltInApiProvider = 'openai' | 'sb2api-async' | 'fal' | 'grok' | 'gemini' | 'claude'
...
export interface ApiProfile {
  ...
  providerDrafts?: Partial<Record<ApiProvider, Partial<Pick<ApiProfile, 'baseUrl' | 'model' | 'imageModel' | 'chatModel' | 'apiMode' | 'reasoningEffort' | 'codexCli' | 'apiProxy' | 'responseFormatB64Json' | 'streamImages' | 'streamPartialImages' | 'transparentBackgroundMethod'>>>>
}
...
export interface AgentRound {
  ...
  chatApiProfileId?: string
  chatApiProfileName?: string
  chatModel?: string
