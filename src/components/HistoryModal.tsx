...
export default function HistoryModal({ onClose, ignoreOutsideClickRef }: HistoryModalProps) {
  ...
  return (
    <div 
      ref={modalRef}
      className="absolute right-0 top-12 w-80 max-w-[calc(100vw-2rem)] max-h-[70vh] bg-white dark:bg-[#1c1c1e] rounded-xl shadow-2xl overflow-hidden flex flex-col border border-gray-200 dark:border-white/10 z-50 text-gray-900 dark:text-gray-200 animate-dropdown-down sm:w-96"
    >
