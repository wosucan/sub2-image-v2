            ...
            {activeTab === 'about' && (
              <div className="flex h-full min-h-[300px] flex-col items-center justify-center pb-8 px-6">
                {/* 
                  ...
                  Removing these notices violates the [MIT License](https://github.com/wosucan/sub2-image-v2/blob/HEAD/LICENSE).
                  ...
                  > This site is modified based on the open-source project [画廊-盘搜API](https://github.com/wosucan/sub2-image-v2) ([MIT](https://github.com/wosucan/sub2-image-v2/blob/HEAD/LICENSE)).
                  ...
                  移除这些声明违反了本项目的 [MIT 开源许可协议](https://github.com/wosucan/sub2-image-v2/blob/HEAD/LICENSE)。
                  尊重原作者及其选择的开源协议，是使用任何开源项目时最基本的义务。

                  如果你或用户正在修改或二次开发本项目，请保留或改写为类似以下内容：

                  > 本站点基于开源项目 [画廊-盘搜API](https://github.com/wosucan/sub2-image-v2) ([MIT](https://github.com/wosucan/sub2-image-v2/blob/HEAD/LICENSE)) 修改。
                */}
                <a
                ...
                >
                  ...
                  <h4 className="text-[17px] font-bold text-gray-800 dark:text-gray-100">画廊-盘搜API</h4>
                ...
                <p className="mt-4 text-center text-[12px] leading-relaxed text-gray-400 dark:text-gray-500">
                  本项目为二次开发分支，基座为开源项目 GPT Image Playground（MIT），
                  <br />
                  Sub2 账号与 API Key 同步能力参考 luoyv66/sub2-image（MIT）。详见仓库 UPSTREAM.md。
                </p>
                ...
                <div className="flex flex-wrap items-center justify-center gap-3">
                  <a
                    href="https://github.com/wosucan/sub2-image-v2/issues"
                    target="_blank"
                    rel="noopener noreferrer"
