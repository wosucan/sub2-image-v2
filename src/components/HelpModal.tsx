    ...
    >
      ...
      >
              ...
              <section>
                <div className="space-y-4">
                  <ul className="list-disc pl-4 space-y-2">
                    <li>登录账号后可同步密钥、余额和账号信息。</li>
                    <li>点击输入框上方的按钮可展开对话模型、绘图模型和绘图参数配置菜单。</li>
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-white/[0.08] flex justify-center">
          ...
          >
            <img src="/pwa-icon.svg" alt="" className="h-5 w-5 rounded-md transition-transform group-hover:scale-110" />
            落羽小站
          </a>
        </div>
      </div>
